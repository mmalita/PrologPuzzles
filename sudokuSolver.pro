...
solve(S):-  Nine=[1,2,3,4,5,6,7,8,9],
    ...
    good(L1,L2),good(L1,L3),
        different(L1,L2),different(L1,L3),different(L1,L4),        
        different(L1,L5),different(L1,L6),different(L1,L7),        
        different(L1,L8),different(L1,L9), 
    permutation(L2,Nine),   %% Line 2
    good(L2,L1),good(L2,L3),
        different(L2,L1),different(L2,L3),different(L2,L4),        
        different(L2,L5),different(L2,L6),different(L2,L7),        
        different(L2,L8),different(L2,L9), 
    permutation(L3,Nine),   %% Line 3
    good(L3,L1),good(L3,L2),
        different(L3,L1),different(L3,L2),different(L3,L4),        
        different(L3,L5),different(L3,L6),different(L3,L7),        
        different(L3,L8),different(L3,L9), 
    ...
    good(L5,L4),good(L5,L6),
        ...
        different(L5,L4),different(L5,L6),different(L5,L7), 
    ...
    good(L6,L4),good(L6,L5),
        ...
        different(L6,L4),different(L6,L5),different(L6,L7),
        different(L6,L8),different(L6,L9),       
    ...
    good(L8,L7),good(L8,L9),
        ...
        different(L8,L7),different(L8,L9),
    ...
    good(L9,L7),good(L9,L8),
        ...
        different(L9,L7),different(L9,L8),
    write_square(S).
